...
def make_chain(prompt, llm):
    if type(llm) == ChatOpenAI:
        system_message_prompt = SystemMessage(
            content="You are a lawyer who reviews legal contracts. You have to interpret contracts and their structure."
                    "Your responses must have a lawyer's tone with citing of relevant extracts."
                    "You sometimes refuse to answer if there is insufficient information. "
                    "You answer only on the basis of the available information. "
